 ...
 * FosUserUser
 *
 * @ORM\Table(name="fos_user_user", uniqueConstraints={@ORM\UniqueConstraint(name="uniq_c560d761a0d96fbf", columns={"email_canonical"}), @ORM\UniqueConstraint(name="uniq_c560d761c05fb297", columns={"confirmation_token"}), @ORM\UniqueConstraint(name="uniq_c560d76192fc23a8", columns={"username_canonical"})})
 * @ORM\Entity
 */
class FosUserUser
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="locale", type="string", length=15, nullable=true)
     */
    private $locale;
    ...
    public function setFacebookData($facebookData): self
    {
    ...
    public function setTwitterData($twitterData): self
    {
    ...
    public function setGplusData($gplusData): self
    {
    ...
    /**
     * @return Collection|FosUserGroup[]
     */
